...
public class BeanAnnotationProcessor extends AbstractAnnotationProcessor {
  ...
  private void processAnnotation(
    ...
    Method[] initAndDestroyMethod = this.getInitAndDestroyMethod(anno, _class);
  ...
  private ScopeType getScoopType(
    ...
    ScopeType scopeType = scope == null ? ScopeType.SINGLETON : scope.value();
    if (element.isAnnotationPresent(Scope.class)) {
      scopeType = AnnotationUtils.getAnnotation(element, Scope.class).value();
    }
    return scopeType;
  }
