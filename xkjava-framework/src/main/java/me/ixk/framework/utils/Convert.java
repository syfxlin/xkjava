...
public class Convert {
    ...
    /**
     * 转换为字符串<br> 如果给定的值为<code>null</code>，或者转换失败，返回默认值<code>null</code><br>
     * 转换失败不会报错
     *
     * @param value 被转换的值
     *
    ...
    /**
     * 转换为字符<br> 如果给定的值为<code>null</code>，或者转换失败，返回默认值<code>null</code><br>
     * 转换失败不会报错
     *
     * @param value 被转换的值
     *
    ...
    /**
     * 转换为byte<br> 如果给定的值为<code>null</code>，或者转换失败，返回默认值<code>null</code><br>
     * 转换失败不会报错
     *
     * @param value 被转换的值
     *
    ...
    /**
     * 转换为Short<br> 如果给定的值为<code>null</code>，或者转换失败，返回默认值<code>null</code><br>
     * 转换失败不会报错
     *
     * @param value 被转换的值
     *
    ...
    /**
     * 转换为int<br> 如果给定的值为<code>null</code>，或者转换失败，返回默认值<code>null</code><br>
     * 转换失败不会报错
     *
     * @param value 被转换的值
     *
    ...
    /**
     * 转换为long<br> 如果给定的值为<code>null</code>，或者转换失败，返回默认值<code>null</code><br>
     * 转换失败不会报错
     *
     * @param value 被转换的值
     *
    ...
    /**
     * 转换为boolean<br> String支持的值为：true、false、yes、ok、no，1,0
     * 如果给定的值为空，或者转换失败，返回默认值<br> 转换失败不会报错
     *
     * @param value        被转换的值
     * @param defaultValue 转换错误时的默认值
     *
    ...
    /**
     * 转换为BigDecimal<br> 如果给定的值为空，或者转换失败，返回null<br> 转换失败不会报错
     *
     * @param value 被转换的值
     *
     * @return 结果
    ...
    /**
     * 转换为Date<br> 如果给定的值为空，或者转换失败，返回默认值<br> 转换失败不会报错
     *
     * @param value        被转换的值
     * @param defaultValue 转换错误时的默认值
     *
    ...
    /**
     * LocalDateTime<br> 如果给定的值为空，或者转换失败，返回默认值<br> 转换失败不会报错
     *
     * @param value        被转换的值
     * @param defaultValue 转换错误时的默认值
     *
    ...
    /**
     * 转换为LocalDateTime<br> 如果给定的值为空，或者转换失败，返回<code>null</code><br> 转换失败不会报错
     *
     * @param value 被转换的值
     *
     * @return 结果
    ...
    /**
     * Instant<br> 如果给定的值为空，或者转换失败，返回默认值<br> 转换失败不会报错
     *
     * @param value        被转换的值
     * @param defaultValue 转换错误时的默认值
     *
    ...
    /**
     * 转换为Date<br> 如果给定的值为空，或者转换失败，返回<code>null</code><br> 转换失败不会报错
     *
     * @param value 被转换的值
     *
     * @return 结果
    ...
    public static <E extends Enum<E>> E toEnum(
        ...
        return (E) (new EnumConverter(clazz)).convertQuietly(
                value,
                defaultValue
            );
    }
    ...
    public static Collection<?> toCollection(
        ...
        return new CollectionConverter(collectionType, elementType)
        .convert(value, null);
    }
    ...
    public static <K, V> Map<K, V> toMap(
        ...
        return (Map<K, V>) new MapConverter(HashMap.class, keyType, valueType)
        .convert(value, null);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T convertByClassName(String className, Object value)
     ...
     * @throws ConvertException 转换器不存在
     */
    public static <T> T convert(TypeReference<T> reference, Object value)
        throws ConvertException {
    ...
    /**
     * 转换值为指定类型，不抛异常转换<br> 当转换失败时返回{@code null}
     *
     * @param <T>   目标类型
     * @param type  目标类型
     * @param value 值
     ...
     * @since 4.5.10
     */
    public static <T> T convertQuietly(
        Type type,
        Object value,
        T defaultValue
    ) {
    ...
    /**
     * 转换值为指定类型，可选是否不抛异常转换<br> 当转换失败时返回默认值
     *
     * @param <T>          目标类型
     * @param type         目标类型
     * @param value        值
    ...
    /**
     * long转byte数组<br> from: https://stackoverflow.com/questions/4485128/how-do-i-convert-long-to-byte-and-back-in-java
     *
    ...
    /**
     * byte数组转long<br> from: https://stackoverflow.com/questions/4485128/how-do-i-convert-long-to-byte-and-back-in-java
     *
     * @param bytes byte数组
     *
     * @return long值
